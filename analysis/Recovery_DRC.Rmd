...
Ind1_75_data <- read_excel("C:/Users/emmap/OneDrive/Desktop/Ward Lab/Experiments/DXR Project/DRCs/5FUProj_DRCTime_78-1_75-1_17-3_EMP_240226.xlsx",
     sheet = "Fin_75_Sheet")
View(Ind1_75_data)
...
Ind3_17_data <- read_excel("C:/Users/emmap/OneDrive/Desktop/Ward Lab/Experiments/DXR Project/DRCs/5FUProj_DRCTime_78-1_75-1_17-3_EMP_240226.xlsx",
     sheet = "Fin_17_Sheet")
View(Ind3_17_data)
...
####Ind1 75-1####
dox_75 <- Ind1_75_data %>% filter(Drug=="DOX")
fluo_75 <- Ind1_75_data %>% filter(Drug=="FLUO")
dmso_75 <- Ind1_75_data %>% filter(Drug=="DMSO")
...
####Ind3 17-3####
dox_17 <- Ind3_17_data %>% filter(Drug=="DOX")
fluo_17 <- Ind3_17_data %>% filter(Drug=="FLUO")
dmso_17 <- Ind3_17_data %>% filter(Drug=="DMSO")
```
...
```{r DRCs 5-Fluorouracil All Timepoints, fig.width=10, fig.height=6, warning=FALSE}
