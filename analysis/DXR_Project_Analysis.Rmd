...
```{r AIC LogFC Plots, fig.height=14, fig.width=8, include = FALSE}
...
```{r Cormotif log2cpm Norm Counts RUVs Plot logFC}
...
```{r DDR Genes Proportion Barplot Cormotif RUVs clustlike}
# DNA_damage_genes <- readRDS("data/new/RUV/DNA_damage_genes_symbolentrez.RDS")
...
```{r DIC Genes Proportion Barplot Cormotif RUVs}
DOX_cardiotox_genes <- readRDS("data/new/RUV/DIC_genes_entrezid.RDS")
...
```{r p53 Target Genes Proportion Barplot Cormotif RUVs}
p53_target_genes <- readRDS("data/new/RUV/p53_targetgenes_entrezid.RDS")
