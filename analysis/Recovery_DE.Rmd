...
# 
# top5DE_d24_a %>% mutate(GeneID = factor(GeneID, levels = c("100996301", "100507533", "116369", "148753", "101929523"))) %>% 
#   cbind(Gene_Name_d24_a)

#top 5 DE genes based on p-value
# ggplot(top5DE_d24_p, aes(x=reorder(Gene_Name_d24_p, P.Value), y=logFC))+
