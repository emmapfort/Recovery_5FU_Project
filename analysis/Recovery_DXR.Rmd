...
counts_cpm_unfilt <- cpm(counts_raw_df, log = TRUE)
...
hist(counts_cpm_unfilt, main = "Recovery All Individuals log2cpm Unfiltered",
...
#cormotif_dxr <- readRDS("data/cormotif_dxr.RDS")
