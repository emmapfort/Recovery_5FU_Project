...
boxplot(fC_Matrix_Full_cpm_filter, xlab = "Conditions", ylab = expression("log"[2]* "counts per million"), ylim= c(-10, 20), main = "Boxplots of log2cpm per sample")
...
annot_list_hm <- data.frame(Individual, Treatment, Time)
...
#         V.D24 V.F24 V.D24r V.F24r V.D144r V.F144r
# Down    4952     0   2282      0     319       0
# NotSig 24083 39938  25569  39938   37760   39938
# Up     10903     0  12087      0    1859       0

```

```{r Do This Again But With Filtering- Yay}
...
top.table_full <- topTable(fit = efit4, n = 20, adjust.method = "BH", resort.by = "logFC")
head(top.table_full)
```
